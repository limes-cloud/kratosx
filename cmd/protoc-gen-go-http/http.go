...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/limes-cloud/kratosx/transport/http")
	bindingPackage       = protogen.GoImportPath("github.com/limes-cloud/kratosx/transport/http/binding")
)
